...
def search_student(students):
    ...
    if roll in students:
        print("Student found!")
        print(f"Name: {students[roll][0]}, Age: {students[roll][1]}, Subject: {students[roll][2]}")
    else:
        print("Student not found!")
...
def print_students(students):
    ...
    for roll in students:
        print(f"Roll number: {roll}, Name: {students[roll][0]}, Age: {students[roll][1]}, Subject: {students[roll][2]}")
